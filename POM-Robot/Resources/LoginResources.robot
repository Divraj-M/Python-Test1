...
${missing_username_error_message}    xpath://span[@class='oxd-text oxd-text--span oxd-input-field-error-message oxd-input-group__message']
${missing_password_error_message}    xpath://span[@class='oxd-text oxd-text--span oxd-input-field-error-message oxd-input-group__message']
